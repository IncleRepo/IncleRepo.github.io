...
lastmod = 2026-08-10T13:07:55+09:00
draft = false
...
실시간 방송에서 시청자가 반응 버튼을 연속해서 누른다고 생각해 보자. 짧은 시간 동안 같은 숫자를 매우 자주 증가시켜야 하지만, 방송이 끝난 뒤에는 최종 반응 수만 오래 보관하면 될 수 있다.
...
이 작업을 매번 다시 하지 않고 이미 만든 결과를 재사용해 DB와 애플리케이션의 반복 작업을 줄이는 데 의미가 있다.
